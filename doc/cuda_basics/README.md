...
建议先学习执行抽象中的基本概念，再看内存优化和同步机制。结合当前代码 `src/cuda_basics/matrix_trans.cu`，可以先按“当前重点路线”学习。
...
- [Thread, Block and Grid](thread_block_grid.md)
...
结合 `src/cuda_basics/matrix_trans.cu`，建议先按这条路线学习：
